...
<body class="flex bg-gray-100">
    ...
    <div class="flex-1 p-6">
        <div class="p-6 bg-white rounded-lg shadow-lg">
            <h2 class="mb-4 text-2xl font-bold">Form Pembelian Barang</h2>

            <form method="POST" action="process.php" class="space-y-4">
                <div>
                    <label class="block font-medium">Pilih Pemasok:</label>
                    <select name="kode_pemasok" required class="w-full p-2 border rounded">
                        <option value="">-- Pilih Pemasok --</option>
                        <?php while ($pemasok = mysqli_fetch_assoc($pemasokResult)) { ?>
                            <option value="<?= $pemasok['kode_pemasok']; ?>">
                ...
                <div>
                    <label class="block font-medium">Nota Pembelian:</label>
                    <input type="text" name="nota_beli" value="<?php echo $nota_beli; ?>" readonly class="w-full p-2 border rounded">
                </div>
                    ...
                    <table class="w-full border border-collapse border-gray-300">
                        ...
                        <tbody id="table-barang">
                            <tr>
                                ...
                                <td><input type="number" name="harga_beli[]" class="w-full p-2 border rounded harga_beli" readonly></td>
                                <td><input type="number" name="jumlah_beli[]" class="w-full p-2 border rounded jumlah_beli" required></td>
                ...
                <div class="mt-4">
                    <p class="font-semibold">Total pembelian: <span id="total_display">0</span></p>
                ...
                <button type="submit" class="px-4 py-2 text-white bg-green-500 rounded">Simpan Pembelian</button>
            </form>
        </div>
    </div>
